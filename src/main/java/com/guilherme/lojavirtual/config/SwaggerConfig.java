...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.guilherme.lojavirtual.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "Loja Virtual API",
                "Esta API é utilizada para criação de uma loja virtual",
                "Versão 1.0",
                "",
                new Contact("Guilherme Magalhães", "https://github.com/Guilherme2907", "guilherme.magalhaes2907@gmail.com"),
                "",
                "",
